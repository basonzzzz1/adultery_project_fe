        ...
        return (<div>
            <div style={{display: "flex", backgroundColor: "#f72d7a", height: "100px"}}>
                ...
                <div>
                    ...
                    <button onClick={()=>setModalBankIsOpen(true)} style={{backgroundColor: "#f72d7a", border: "2px solid grey", marginTop: "15px", color :"white",width:"190px"}}>
                        đổi điểm
                    </button>
                </div>
            ...
            >
                <div style={{width :"100%",display:"flex",marginTop :"50px",marginLeft:"30px"}}>
                    <h6>Tên Ngân Hàng :</h6><input id={"BankName"}  style={{marginLeft:"10px"}} type="text" placeholder={"Tên ngân hàng !"}/>
                </div>
                <div style={{width :"100%",display :"flex",marginTop:"10px",marginLeft:"30px"}}>
                    <h6>Số Tài Khoản :</h6><input id={"BankCode"}  style={{marginLeft:"25px"}} type="number" placeholder={"Số Tài khoản ngân hàng !"}/>
                </div>
                <div  style={{width :"100%",display :"flex",marginTop:"10px",marginLeft:"30px"}}>
                    <h6>Số Điểm Đổi :</h6><input id={"BankPoint"} style={{marginLeft:"32px"}} type="number" placeholder={"Số điểm đổi !"}/>
                </div>
                <div  style={{width :"100%",display :"flex",marginTop:"10px",marginLeft:"30px"}}>
                    <h6>Nội dung :</h6><input id={"BankContent"} style={{marginLeft:"57px"}} type="number" placeholder={"Nội dung !"}/>
                </div>
                <div style={{width :"100%",display :"flex",marginTop:"10px",marginLeft:"30px"}}>
